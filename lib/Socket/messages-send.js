...
const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            // ===== PATCH: HANDLE PIN / UNPIN MESSAGE (VERSION FIX) =====
            if (content && typeof content === 'object') {       
                ...
                if (isPin || isUnpin) {
                    ...
                    const pinMessage = {
                        pinInChatMessage: {
                            key: pinData.key,
                            type: isUnpinAction ? 2 : 1, // 1 = PIN, 2 = UNPIN
                            senderTimestampMs: Date.now()
                        }
                    };

                    // KALAU PIN, BISA TAMBAH DURASI
                    ...
                    // Tambah participant kalau ada filter
                    if (filter) {
                        relayOptions.participant = { jid };
                    }

                    await relayMessage(jid, pinMessage, relayOptions);
